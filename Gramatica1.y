...
%%
	...
	factor : variable
	       | CTE_E {this.agregarConstante(,"int",false)}
		   | CTE_F {this.agregarConstante(,"float",false)}
		   | '-' CTE_E {this.agregarConstante(((Token)$2.obj).getLexema(),"int",true)}
		   | '-' CTE_F {this.agregarConstante(((Token)$2.obj).getLexema(),"float",true)}
		   | invocacion_metodo
		   ;
